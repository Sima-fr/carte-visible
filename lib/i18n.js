...
export function setExtraUiStrings(obj) {
  extraUiStrings = obj || {};
}

export function t(lang, key, ...args) {
  const dict = UI_STRINGS[lang] || extraUiStrings[lang] || UI_STRINGS.fr;
  const val = dict[key] ?? extraUiStrings[lang]?.[key] ?? UI_STRINGS.fr[key];
