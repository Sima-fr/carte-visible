export const UI_STRINGS = {
  fr: {
    menuTitle: 'La carte',subheading: "Un coup d'œil avant de commander : touchez un plat pour voir la photo en grand — ou ajoutez-le directement à votre commande.",
  ...
  en: {
    menuTitle: 'Menu',subheading: "A quick look before you order: tap a dish to see the full photo — or add it straight to your order.",
  ...
  de: {
    menuTitle: 'Speisekarte',subheading: 'Ein Blick vor der Bestellung: Tippen Sie auf ein Gericht, um das Foto in voller Größe zu sehen — oder fügen Sie es direkt Ihrer Bestellung hinzu.',
